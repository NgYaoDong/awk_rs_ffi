...
const char bb_msg_memory_exhausted[] ALIGN1 = "out of memory"; // message.c
const char bb_msg_standard_output[] ALIGN1 = "standard output"; // message.c
