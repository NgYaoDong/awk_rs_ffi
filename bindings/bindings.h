...
// typedef  _regmatch_t regmatch_t;
...
struct FILE* fopen_or_warn(const char *filename, const char *mode) FAST_FUNC;
struct FILE* xfopen_stdin(const char *filename) FAST_FUNC;
struct FILE* xfopen(const char *filename, const char *mode) FAST_FUNC;

// from stdio.h
extern size_t fread (void *__restrict __ptr, size_t __size,
       size_t __n, struct FILE *__restrict __stream) ;
extern int fclose (struct FILE *__stream);
extern int pclose(struct FILE *__stream);
// end from
...
void bb_show_usage(void) FAST_FUNC;
...
extern int fileno (struct FILE *__stream);
extern int regexec (const struct regex_t * __preg,
      const char * __String, size_t __nmatch,
      struct regmatch_t __pmatch[__nmatch],
      int __eflags);
extern int fflush(struct FILE *__stream);
extern int fputs(const char * __s, struct FILE * __stream);
extern struct FILE *popen(const char *__command, const char *__modes);
extern void regfree(regex_t *__preg);
extern struct FILE* FAST_FUNC fopen_for_read(const char *path);
...
extern const char EMSG_INTERNAL_ERROR[] ALIGN1;
extern const char EMSG_UNEXP_EOS[] ALIGN1;
extern const char EMSG_UNEXP_TOKEN[] ALIGN1;
extern const char EMSG_DIV_BY_ZERO[] ALIGN1;
extern const char EMSG_INV_FMT[] ALIGN1;
extern const char EMSG_TOO_FEW_ARGS[] ALIGN1;
extern const char EMSG_NOT_ARRAY[] ALIGN1;
extern const char EMSG_POSSIBLE_ERROR[] ALIGN1;
extern const char EMSG_UNDEF_FUNC[] ALIGN1;
extern const char EMSG_NO_MATH[] ALIGN1;
extern const char EMSG_NEGATIVE_FIELD[] ALIGN1;
